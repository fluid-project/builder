...
/*
 * Note that this data is used both by the demo and by the tests, so changes
 * to this data must be checked in both places.
 * 
 */
fluid.infusionBuilder.dependencies = {
    model: {
        ...
        groupInfo: [{
            ...
            groupModules: ["inlineEdit", "pager", "progress", "reorderer", "tableOfContents", "uiOptions", "undo", "uploader"]
        }, {
            groupName: "Third Party",
            groupDescription: "Third Party Modules Descriptoin",
            groupModules: ["fastXmlPull", "json", "jQuery", "jQueryUICore", "jQueryUIWidgets", "jQueryDelegatePlugin", "jQueryTooltipPlugin", "jQuerybgiframePlugin", "swfupload", "Cats!"]
        }],
        ...
        }, //index 12
        {
            ...
            moduleDependencies: ["fss", "jQuery", "jQueryUICore", "framework", "renderer", "jQueryUIWidgets", "tableOfContents", "json"]
        }, //index 13
        {
            moduleValue: "undo",
            moduleName: "Undo",
        ...
        }, //index 14
        {
            ...
            moduleDependencies: ["jQuery", "jQueryUICore", "framework", "Cats!", "swfupload", "progress"]
        }, //index 15
        {
